...
if __name__ == '__main__':
    ...
    # Figure out what is the average length of all tweets in the dataframe
    ...
    time_retweets.plot(figsize=(16, 8), label="likes", legend=True)
    time_retweets = pd.Series(data=df['retweets'].values, index=df['date'])
    time_retweets.plot(figsize=(16, 8), label="retweets", legend=True)
