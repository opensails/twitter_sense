...
import re
# Making use of a regular expression to clean the tweet
# other than the text of the tweet
...
class TweetAnalyzer():
    ...
    def anaylze_sentiment(self, tweet):
        ...
        if analysis.sentiment.polarity > 0:
            ...
            return 0  # netural interperation of tweet
        else:
            return -1  # negative interperation of tweet
...
if __name__ == '__main__':
    ...
    df['sentiment'] = np.array(
        [tweet_analyzer.anaylze_sentiment(tweet) for tweet in df['tweets']])
